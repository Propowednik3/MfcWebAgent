...
#define WM_NOTIFIER_LEFT_CLICKED		WM_USER+123
#define WM_NOTIFIER_RIGHT_CLICKED		WM_USER+124
#define WM_NOTIFIER_DBL_LEFT_CLICKED	WM_USER+125
#define WM_NOTIFIER_WINDOW_HIDED		WM_USER+126
...
public:
	...
	void Show(char* szLogo, char* szCaption, char* szBody,DWORD dwTimeToShow=500,DWORD dwTimeToStay=3000,DWORD dwTimeToHide=500,int nIncrement=1);
	void Hide();
	...
	void ExtraHide(int nIncrement);
	void Wait(DWORD dwTimeToLive);
